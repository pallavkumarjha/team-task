      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300"> {/* Added transition */}
        <div className="max-w-3xl mx-auto bg-white dark:bg-slate-800 shadow-lg rounded-xl p-8 border border-slate-200 dark:border-slate-700 transition-colors duration-300"> {/* Added border and transition */}
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-slate-700 dark:text-slate-300 transition-colors duration-300">
            ...
            <ul className="list-disc list-inside text-slate-600 dark:text-slate-400 space-y-2 transition-colors duration-300">
          ...
          <div className="text-center mt-10 text-slate-500 dark:text-slate-400 transition-colors duration-300"> {/* Slightly lighter gray in dark mode */}
